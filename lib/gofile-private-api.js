                                                                    ...
                                                                    case 0:
                                                                      if (res.headers['content-length']) {
                                                                        ...
                                                                        _this3.axios.get(file, {
                                                                          ...
                                                                          _this3.cache[file] = res2.data;
                                                                          resolve2("".concat(name, "/").concat(_lodash["default"].size(res2.data)));
                                                                        })["catch"](reject2);
                                                                      }
                ...
                switch (_context10.prev = _context10.next) {
                  ...
                  case 5:
                    ...
                    _this5.axios.post("https://".concat(res.data.data.server, ".gofile.io/upload"), formData, {
                      ...
                      if (res2.data.status === 'ok') {
                        _this5.axios.get("https://".concat(_this5.apiServer, ".gofile.io/getServer?c=").concat(res2.data.data.code)).then(function (res3) {
                          if (res3.data.status === 'ok') {
                            _this5.axios.get("https://".concat(res3.data.data.server, ".gofile.io/getUpload?c=").concat(res2.data.data.code)).then(function (res4) {
                              if (res4.data.status === 'ok') {
                                _this5.fileUploadEmitter.emit('completed', res4.data.data);
                              } else {
